 ...
 * Example :
 * --------
 * [4,2,1,6,5] => 4,5 and 6 are longest consective array so return is 3
 *
 * Solution :
 * We will use HashMap. The key thing is to keep track of the sequence length and store that in the boundary points of the sequence. For example, as a result, for sequence {1, 2, 3, 4, 5}, map.get(1) and map.get(5) should both return 5.
 ...
 while 0 means there is no sequence and n will be the boundary point later. Store (left + right + 1)
...
public class LongestConsecutiveArray {
    ...
    public static void main(String[] args) {
        System.out.println(longestConsecutive(new int[] {4,2,1,6,5}));
