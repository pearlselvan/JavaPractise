 ...
 * however they have to be of equal
 * length.

 It measures the minimum number of substitutions for
 the two strings to be equal.
...
public class HammingDistance_CounterforStringtoEqual {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getHammingDistance("muthu","kuthu"));
        System.out.println(getHammingDistance("fog","dog"));
