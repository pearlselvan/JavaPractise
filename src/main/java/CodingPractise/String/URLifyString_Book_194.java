 ...
 * Good : http://algorithms.tutorialhorizon.com/replace-all-spaces-in-a-string-with/
 *
 *
 ...
 *
 */
public class URLifyString_Book_194 {
...
//        System.out.println(replace(url.toCharArray(),url.length()));
        ...
        URLifyString_Book_194 r = new URLifyString_Book_194();
