 ...
 *
 *
 * Created by muthuselvan on 9/11/17.
 * import java.io.*;
 import java.util.*;
...
class Solution {
    ...
    static class BinarySearchTree {
        ...
        Node findInOrderSuccessor(Node inputNode) {
            // your code goes here
            //step 1:  right sub is not NULL :
            if (inputNode.right!=null) {
                return minValue(inputNode.right);  // 11
            } // End if
            ...
            while (parent!=null && inputNode == parent.right) {
                ...
                inputNode = parent ;  //ip = 9
                parent=parent.parent; //p = 20
            } // End while
...
public class InorderSuccessor_pramp {
