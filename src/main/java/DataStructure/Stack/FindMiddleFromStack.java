 ...
 *
 *
 * Since the stack's size is not limited we can choose a linked list or
 * preferably double linkedlist to store and retireve the elements
 * of stack.
 *
 * Advantage of using doubly linked list is deletion of middle element would be easy.
